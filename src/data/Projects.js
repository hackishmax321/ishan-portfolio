const projects = [
  ...
  },
  {
    ...
    tags: ["React.JS", "Python", "Colabotory Nodebooks", "Mongo DB"],
    images: [
      "edu-logo.png",
  ...
  },
  {
    ...
    tags: ["React", "Python (Fast API)", 'Colabotory Nodebooks', "Mongo DB"],
    images: [
      "catlem-logo.png",
  ...
  {
    id: 4,
    title: "Provincial Council Work Management Site",
    description: "A web application created to manage govenment based acrivities of provincial sector and mange them effectively.",
